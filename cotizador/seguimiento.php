...
<script type="text/javascript">
	...
	function ver_preview(cot) {
        ...
        function reenviar_mail(cot) {
            popwindow("reenvia_mail.php?cot="+cot,800,600)
        }
</script>
</head>
...
<td  valign="top" class="label_left_right_top_bottom" STYLE="PADDING-LEFT:20px; PADDING-RIGHT:20px; TEXT-ALIGN:left">
	...
	<tr><td>
		...
		<tr>
			...
			<td class="titulo_tabla" width="10%" align="middle">Numero</td>
			<td class="titulo_tabla" width="10%" align="middle">Rut</td>
			...
			<td class="titulo_tabla" width="5%" align="center" style="text-align: center">&nbsp;</td>
		</tr>
		<?php
			$j = 0;
			$iTotPrd = 0;
			$result = mssql_query("vm_s_cot_seg", $db);
			while ($row = mssql_fetch_array($result)) {
				...
				echo "   <td class=\"".$clase2."\" style=\"TEXT-ALIGN: left \"><a href=\"javascript:reenviar_mail(".$row['Cod_Cot'].")\"><img src=\"../images/email2.png\" alt=\"\" title=\"Reenviar Cotizaci&oacute;n\"></a></td>\n";
				$j = 1 - $j;
				$iTotPrd++;
			}
		...
		<tr>
			...
			NO EXISTEN COTIZACIONES PENDIENTES DE RESPUESTA POR PARTE DE LOS CLIENTES.<br />
                        SI DESEA ENCONTRALA DEBE IR A LA OPCI&Oacute;N <a href="historicorep.php">HISTORICO</a>
			</td>
		</tr>
