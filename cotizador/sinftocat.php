...
<td  valign="top" class="label_left_right_top_bottom" STYLE="PADDING-LEFT:20px; PADDING-RIGHT:20px; TEXT-ALIGN:left">
	...
	<tr><td>
		...
		<tr>
			...
			<td class="titulo_tabla" width="10%" style="text-align: center">Patr&oacute;n</td>
		</tr>
		<?php
			$j = 0;
			$iTotPrd = 0;
			$result = mssql_query("vm_det_sinftoctl", $db);
			while ($row = mssql_fetch_array($result)) {
				...
				echo "   <td class=\"".$clase2."\" style=\"TEXT-ALIGN: center; \">".$row['Cod_GrpPat']."</td>\n";
		...
		<tr>
			...
			NO EXISTEN PRODUCTOS SIN FOTOS EN EL CATALOGO.
			</td>
		</tr>
