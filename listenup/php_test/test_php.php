  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr valign="middle">
      ...
      <td bgcolor="#DCE2E7"><center>
          <h1><!-- InstanceBeginEditable name="mainHeading" -->Test PHP On Server <!-- InstanceEndEditable --></h1>
        </center></td>
    </tr>
  </table>
</center>
...
<p>
You should see a message that says "PHP is Working!" below.
<p>
<blockquote>
<pre>
<?php
	// IF YOU SEE THIS PHP COMMENT IN YOUR BROWSER THEN PHP IS NOT WORKING!
	echo "PHP is "; // NOT
	echo "Working!\n";
...
<p>If not then please consider installing <a href="http://www.php.net">PHP</a> on your server.
...
<pre>
<?php
	echo "Web Host = " . $_SERVER['SERVER_NAME'] . "\n";
?>
</pre>
</blockquote>
<p>[<a href="index.html">Test Home</a>] [<a href="play_welcome.html">Previous</a>] [<a href="test_post.php">Next</a>] 
