...
<p style="background-color:#FFFF55">IMPORTANT: This test uses an ASP server script called <strong>&quot;handle_upload_simple.asp&quot;</strong> to receive the uploaded file. You can use that as a starting point for writing your own server scripts.</p>

    <ol>
      <li> When you see the Applet appear, click the red circle and speak
...
<p><br>
	...
	<!-- Specify URL and file to be played after upload. -->
                    <param name="refreshURL" value="play_message.asp?sampleName=message_12345.wav">
	...
	<!-- Server script to receive the multi-part form data. -->
                    <param name="uploadURL" value="handle_upload_simple.asp">
    </applet>
</p>
<p>[<a href="index.html">Test Home</a>] [<a href="test_write.asp">Previous</a>] [<a href="record_upload_spx.asp">Next</a>] </p>
