...
<FORM ACTION="handle_file_upload.asp" method="post" encType="multipart/form-data">
User Comment: 
...
[<a href="index.html">Test Home</a>] [<a href="test_asp.asp">Previous</a>] [<a href="test_write.asp">Next</a>] 
</pre>
