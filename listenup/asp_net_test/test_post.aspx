...
<H2>Use .Net's HttpPostedFile to Handle an Uploaded File </H2>
<p>This HTML FORM simulates the action of the ListenUp Applet. It sends information
  and a file to the server an HTML POST. </p>
<p>Please select a small file on your hard drive and hit the "Send File" button.
  After upload, the status line in the form will be updated, and if successful
  the POSTed information will be echoed by a script. The file will not be saved
  on your server. </p>
...
<FORM ACTION="handle_file_upload.aspx" method="post" encType="multipart/form-data">
User Comment: 
  <INPUT size=60 value="hello earth" name=userComment><BR>
Send this local file: <INPUT type=file name=userfile><BR>
<INPUT type=submit value="Send File"> 
</FORM>
<p>&nbsp;</p>
[<a href="index.html">Test Home</a>] [<a href="test_asp_net.aspx">Previous</a>] [<a href="test_write.aspx">Next</a>] 
</pre>
