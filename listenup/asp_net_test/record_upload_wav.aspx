...
<p style="background-color:#FFFF55">IMPORTANT: This test uses an ASP server script called <strong>&quot;handle_upload_simple.aspx&quot;</strong> to receive the uploaded file. You can use that as a starting point for writing your own server scripts.</p>
...
<p><br>
	...
	<!-- Specify URL and file to be played after upload. -->
                    <param name="refreshURL" value="play_message.aspx?sampleName=message_12345.wav">
	...
	<!-- Server script to receive the multi-part form data. -->
                    <param name="uploadURL" value="handle_upload_simple.aspx">
    </applet>
</p>
<p>[<a href="index.html">Test Home</a>] [<a href="test_write.aspx">Previous</a>] [<a href="record_upload_spx.aspx">Next</a>] </p>
