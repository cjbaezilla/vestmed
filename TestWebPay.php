...
$TBK_URL_EXITO = "http://gu.inaf.cl/kcc/exito.php";
$TBK_URL_FRACASO = "http://gu.inaf.cl/kcc/fracaso.php";
//$url_cgi = "http://localhost/vestmed/ListPost.php";
$url_cgi = "http://localhost/motos/cgi-bin/tbk_bp_pago.cgi";
