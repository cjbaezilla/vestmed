...
if (isset($_GET['val_dsp']))        $val_dsp = intval(ok($_GET['val_dsp']));
...
if (($row = mssql_fetch_array($result))) {
	...
	if (trim($nom_bco) != '' and (trim($arc_adj) != '' or trim($num_trnbco) != '')) {
            ...
            $labelpgo = "Pago";
            $linkpgo = "javascript:ing_comprobante()";
	}
...
<script type="text/javascript">
    ...
    function listMessage(xml)
    {
		...
		if (parseInt(qty_sinlect) > 0) {
		    NewHTML+='/<a href=\"javascript:ver_mensaje(<?php echo $Cod_Cot;?>)\">' + qty_sinlect + ' no leido(s)</a>';
        }
		NewHTML+='</font>';
		NewHTML+='</td>';
		NewHTML+='</tr>';
		NewHTML+='<tr>';
		NewHTML+='<td style="padding-left: 40px"><font size="1"><a href="javascript:ver_mensaje(<?php echo $Cod_Cot;?>)">Redactar Nuevo</a></font></td>';
		NewHTML+='</tr>';
		NewHTML+='</table>';
    ...
    function listDirFct(xml)
    {
        ...
        $j("filter",xml).each(
            function(id) {
				...
				val_dsp= parseFloat($j("val_dsp",filter).text());
        ...
        if (codtrn == 200) {
            ...
            tbl  = "<table id=\"desdsp\" cellspacing=\"0\" cellpadding=\"1\">";
            if (isdsp != 0) {
                tbl += "<tr>";
                ...
                tbl += "</tr>";
				tbl += "<tr>";
				tbl += "<td style=\"padding-left: 40px\"><font size=\"1\">Valor: " + val_dsp + "</font></td>";
				tbl += "</tr>";
    ...
    function ver_comprobante(comprobante) {
        ...
        popwindow("VerComprobante.php?archivo="+comprobante,140,140,600,480);
    }
    ...
    function MostrarDespacho() {
        popwindow('UpdDsp.php?cot=<?php echo $Cod_Cot ?>',350,100,820,450);
    }
    ...
    function ing_comprobante() {
        popwindow('IngPago.php?cot=<?php echo $Cod_Cot ?>&montoNvt=<?php echo $mto_odc; ?>',350,300,620,170);
    }
                ...
                <li>
                    ...
                    <ul>
                       <li>
                        ...
                        <li>
                            <a href="como-tomar-medidas.htm">C�mo Tomar Medidas</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="tracking-ordenes.htm">tracking de �rdenes</a>
                        </li>
                        <li>
                            <a href="como-cotizar.htm">C�mo Cotizar</a>
                        </li>
                       
                        <li>
                            <a href="politicas-privacidad.htm">Pol�ticas de Privacidad</a>
                        </li>
                    </ul>
                </li>
            </ul>		
...
-->					   		<td style="padding-left: 40px"><font size="1"><a href="javascript:ver_mensaje(<?php echo $Cod_Cot;?>)">Redactar Nuevo</a></font></td>
						...
						<?php if ($is_dsp == 1) { ?>
                                                <tr><td>
                                                    <table id="desdsp" cellspacing="0" cellpadding="1">
                                                    <tr>
						...
						<?php } ?>
					   	...
					   	<tr>
					   		<td><font color="#a9a9a9" size="2">Total Orden:</font> <b><span id="mtopago">$<?php echo number_format($mto_odc,0,',','.'); ?></span></b>&nbsp;
