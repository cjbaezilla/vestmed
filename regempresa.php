		...
		if ($row = mssql_fetch_array($result)) {
			...
			if ($Cod_Clt != "") { // Si es cliente
				...
				while ($row = mssql_fetch_array($result))
					if ($row["Cod_Pro"] < 0 || $bPrimero || $row["Pwd_Web"] != "") {
			...
			<div id="back-registro">
				...
				<TABLE WIDTH="80%" BORDER="0" style="text-align:left;">
					  ...
					  <TD width="80%" VALIGN="top">
						 <TABLE border="0" cellpadding="1" cellspacing="0" width="100%" >
							...
							<TR>
								...
								<TD>
									<INPUT name="dfAppPatIn" size="30" maxLength="80" class="textfieldv2" style="TEXT-TRANSFORM: uppercase" onchange="llenarCampo(this)" value="<?php echo $AppPat; ?>" <?php if ($CodPerCtt>0) echo "readOnly" ?>></TD>
							</TR>
                            <TR>
								<TD CLASS="etiqueta">Materno:&nbsp;</TD>
								<TD>
									<INPUT name="dfAppMatIn" size="30" maxLength="80" class="textfieldv2" style="TEXT-TRANSFORM: uppercase" onchange="llenarCampo(this)" value="<?php echo $AppMat; ?>" <?php if ($CodPerCtt>0) echo "readOnly" ?>>
									</TD>
							</TR>
                           
							<TR>
								<TD CLASS="etiqueta">Nombres:&nbsp;</TD>
								<TD><INPUT name="dfNomUsrIn" size="60" maxLength="80" class="textfieldv2" style="TEXT-TRANSFORM: uppercase" onchange="llenarCampo(this)" value="<?php echo $NomPer; ?>" <?php if ($CodPerCtt>0) echo "readOnly" ?>></TD>
							</TR>
							<?php if ($CodPerCtt == 0) { ?>
							<TR>
							...
							<TR>
								...
								<TD>
								<INPUT id="rbSexoIn" name="rbSexoIn" type="radio" onclick="llenarCampo(this)" value="2" <?php if ($CodSex == 2) echo "checked"; ?> <?php if ($CodPerCtt>0) echo "readOnly" ?>>&nbsp;<strong>Hombre</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<INPUT id="rbSexoIn" name="rbSexoIn" type="radio" onclick="llenarCampo(this)" value="1" <?php if ($CodSex == 1) echo "checked"; ?> <?php if ($CodPerCtt>0) echo "readOnly" ?>>&nbsp;<strong>Mujer</strong>
								</TD>
							</TR>
							<TR>		
							   <TD CLASS="etiqueta">Tel&eacute;fono de contacto&nbsp;:&nbsp;<SPAN class="dator">*</SPAN></TD>
							   <TD>
								 <INPUT name="dfTelefonoUsrIn" size="12" maxLength="15" class="textfieldv2" onKeyPress="SoloNumeros(this)"  onchange="llenarCampo(this)" value="<?php echo $FonSuc; ?>" <?php if ($CodPerCtt>0) echo "readOnly" ?>></TD>
							</TR>
                            <TR>		
							   <TD CLASS="etiqueta">Fax:&nbsp;<SPAN class="dator">*</SPAN></TD>
							   <TD>
								 <INPUT name="dfFaxUsrIn" size="12" maxLength="15" class="textfieldv2" onKeyPress="SoloNumeros(this)" onchange="llenarCampo(this)" value="<?php echo $FaxSuc; ?>" <?php if ($CodPerCtt>0) echo "readOnly" ?>>
							   </TD>
							</TR>
                            <TR>		
							   <TD CLASS="etiqueta">M&oacute;vil:&nbsp;<SPAN class="dator">*</SPAN></TD>
							   <TD>
								 <INPUT name="dfMovilUsrIn" size="12" maxLength="15" class="textfieldv2" onKeyPress="SoloNumeros(this)" onchange="llenarCampo(this)" value="<?php echo $CelCtt; ?>" <?php if ($CodPerCtt>0) echo "readOnly" ?>>
							   </TD>
							</TR>
							<TR>
								<TD CLASS="etiqueta">E-Mail:&nbsp;</TD>
								<TD><INPUT name="dfemailIn" size="60" maxLength="80" class="textfieldv2" style="TEXT-TRANSFORM: none" onchange="llenarCampo(this)" value="<?php echo $MailCt; ?>" <?php if ($CodPerCtt>0) echo "readOnly" ?>></TD>
							</TR>
							<TR>		
							...
							<?php } ?>
							<?php if ($EsCliente && $bExisteUsr && $CodPerCtt > 0) { ?>
							...
							<TR><TD colspan="2" CLASS="dato" style="TEXT-ALIGN:left; PADDING-TOP: 10px"><strong>
								...
								<?php } ?>
							<?php } ?>
							<?php if ($EsCliente && $CodPerCtt == 0) { ?>
							<TR><TD colspan="2" CLASS="dato" style="TEXT-ALIGN:left; PADDING-TOP: 10px"><strong>
								Usted ya se encuentra registrado como cliente de Vestmed. Sin embargo no tiene<BR>clave de acceso al
								sitio debido a que no tenemos registrado un contacto. Favor<BR>complete la informaci&oacute;n solicitada y
								a continuaci&oacute;n presione la tecla &lt;Enviar&gt;.</strong><BR><BR>
							</TD></TR>
							<?php } ?>
						  </TABLE>
					...
					<form ID="F2" method="post" name="F2" 
						  ...
						  <INPUT type="hidden" name="dfCodSuc" value="<?php echo $CodSuc; ?>">
						  ...
						  <?php }
								if ($EsCliente && !$bExisteUsr && trim($MailCt) == '' &&  $CodPerCtt > 0) {
						  ?>
