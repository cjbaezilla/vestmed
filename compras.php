...
<P align="left" style="PADDING-LEFT: 5px"><strong>Reposiciones Vigentes</strong></P>
<P align="center">
...
<tr><td style="PADDING-TOP: 20px">
	...
	<?php
		...
		$xis = 0;
		$result = mssql_query("vm_odc_s $tipcna, '$fechain', '$fechafi', '3'", $db);
		while ($row = mssql_fetch_array($result)) {
			...
			echo "   <TD class=\"".$clase2."\" style=\"TEXT-ALIGN: center\">".($row['Est_Odr'] == "1" ? "Pendiente" : "Vigente")."</TD>\n";
			echo "   <TD class=\"".$clase2."\" style=\"TEXT-ALIGN: left\"><a href=\"compra.php?cod=".$row['Num_Odr']."&fec=$Fec_Mov\">Detalle</a></TD>\n";
			echo "</TR>\n";
			$j = 1 - $j;
			$iTotPrd++;
		}
